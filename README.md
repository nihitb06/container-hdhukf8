...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hdhukf8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hdhukf8.containers.anotherwebservice.com/
...
```
git clone git@github.com:nihitb06/container-hdhukf8.git
cd container-hdhukf8
```
...
```
docker attach container-hdhukf8
```
